...
* Multi-core support. Leaf utilize its modules and [leaf/go](https://github.com/XieChaoKang/leaf_vg/tree/master/go) to make use of CPU resouces at maximum while avoiding varieties of side effects may be caused.
...
A game server implemented with Leaf may include many modules (e.g. [LeafServer](https://github.com/XieChaoKang/leaf_vgserver)) which all share below traits:

* Each module runs inside a separate goroutine
* Modules communicate with one another via a light weight RPC channel([leaf/chanrpc](https://github.com/XieChaoKang/leaf_vg/tree/master/chanrpc))
...
[LeafServer](https://github.com/XieChaoKang/leaf_vgserver) is a game server developped with Leaf. Let's start with it.
...
More references are at [leaf/go](https://github.com/XieChaoKang/leaf_vg/blob/master/go)。
...
More references are at [leaf/timer](https://github.com/XieChaoKang/leaf_vg/blob/master/timer)。
...
More references are at [leaf/log](https://github.com/XieChaoKang/leaf_vg/blob/master/log).

### Leaf recordfile

Leaf recordfile is formatted in CSV([Example](https://github.com/XieChaoKang/leaf_vg/blob/master/recordfile/test.txt)). recordfile is to manage the configuration for game. The usage of recordfile in LeafServer is quite simple:
...
Refer to [leaf/recordfile](https://github.com/XieChaoKang/leaf_vg/blob/master/recordfile) for more details.

Learn more
----------

More references are at Wiki [https://github.com/XieChaoKang/leaf_vg/wiki](https://github.com/XieChaoKang/leaf_vg/wiki)
